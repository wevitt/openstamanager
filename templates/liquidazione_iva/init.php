...
$iva_vendite_esigibile = $dbo->fetchArray('
    ...
    FROM
        ...
        ) AND co_documenti.data_competenza >= '.prepare($date_start . ' 00:00:00').' AND co_documenti.data_competenza <= '.prepare($date_end . ' 00:00:00').'
    ...
    UNION
        ...
        WHERE
            vb_venditabanco.data >= '.prepare($date_start . ' 00:00:00').' AND vb_venditabanco.data <= '.prepare($date_end . ' 00:00:00').' AND vb_righe_venditabanco.is_descrizione = 0 AND vb_stati_vendita.descrizione = "Pagato"
        GROUP BY
