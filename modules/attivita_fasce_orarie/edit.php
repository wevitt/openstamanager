...
$elementi = $dbo->fetchArray('SELECT at_tipiattivita.codice, at_tipiattivita.descrizione, at_tipiattivita.idtipointervento FROM at_tipiattivita LEFT JOIN at_fasceorarie_tipiattivita ON at_tipiattivita.idtipointervento=at_fasceorarie_tipiattivita.idtipointervento WHERE at_fasceorarie_tipiattivita.idfasciaoraria='.prepare($id_record));
