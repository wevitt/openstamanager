...
<form action="" method="post" id="copia-intervento">
    ...
    <input type="hidden" name="op" value="create-subactivity">
    ...
    <div class="row">
        <div class="col-md-6">
            {[ "type": "select", "label": "'.tr('Stato').'", "name": "id_stato", "required": 1, "values": "query=SELECT idstatointervento AS id, descrizione, colore AS _bgcolor_ FROM at_stati_attivita WHERE deleted_at IS NULL ORDER BY descrizione", "value": "" ]}
        </div>
