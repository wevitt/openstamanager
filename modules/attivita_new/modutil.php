 ...
 * @deprecated 2.4.25
 */
function link_componente_to_articolo_attivita($id_intervento, $id_impianto, $id_articolo, $qta)
{
 ...
 * @deprecated
 */
function calcola_ore_attivita($orario_inizio, $orario_fine)
{
...
function aggiungi_attivita_in_fattura($id_intervento, $id_fattura, $descrizione, $id_iva, $id_conto, $id_rivalsa_inps = false, $id_ritenuta_acconto = false, $calcolo_ritenuta_acconto = false)
{
    $dbo = database();
    ...
    $dbo->query("UPDATE at_attivita SET idstatointervento=(SELECT idstatointervento FROM at_statiattivita WHERE codice='FAT') WHERE id=".prepare($id_intervento));
}
 ...
 * @return bool|string
 */
function verifica_numero_attivita(Intervento $intervento)
{
