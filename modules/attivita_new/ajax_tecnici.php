...
$rss = $dbo->fetchArray('SELECT is_completato AS flag_completato FROM at_stati_ttivita WHERE idstatointervento = (SELECT idstatointervento FROM at_attivita WHERE id='.prepare($id_record).')');
...
$query = 'SELECT
    at_attivita_tecnici.*,
    (at_attivita_tecnici.prezzo_ore_unitario * at_attivita_tecnici.ore - at_attivita_tecnici.sconto) AS prezzo_ore_consuntivo,
    (at_attivita_tecnici.prezzo_km_unitario * at_attivita_tecnici.km - at_attivita_tecnici.scontokm) AS prezzo_km_consuntivo,
    (at_attivita_tecnici.prezzo_ore_unitario_tecnico * at_attivita_tecnici.ore) AS prezzo_ore_consuntivo,
    (at_attivita_tecnici.prezzo_km_unitario_tecnico * at_attivita_tecnici.km) AS prezzo_km_consuntivo,
    an_anagrafiche.ragione_sociale,
    an_anagrafiche.deleted_at AS anagrafica_deleted_at,
    at_tipiattivita.descrizione AS descrizione_tipo,
    at_attivita_tecnici.tipo_scontokm AS tipo_sconto_km,
    user.id AS id_user
FROM
    at_attivita_tecnici INNER JOIN an_anagrafiche
    ON at_attivita_tecnici.idtecnico = an_anagrafiche.idanagrafica
        ...
        ON user.idanagrafica = an_anagrafiche.idanagrafica
            INNER JOIN at_tipiattivita
            ON at_attivita_tecnici.idtipointervento = at_tipiattivita.idtipointervento
WHERE
    at_attivita_tecnici.idintervento='.prepare($id_record).'
ORDER BY
    ragione_sociale ASC,
    at_attivita_tecnici.orario_inizio ASC,
    at_attivita_tecnici.id ASC';
