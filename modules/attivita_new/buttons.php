...
// Duplica intervento
echo '
<button type="button" class="btn btn-primary " onclick="creaSottoattivita()">
    <i class="fa fa-copy"></i> '.tr('Crea sottoattività').'
</button>
...
<script>
    function creaSottoattivita() {
        openModal("'.tr('Crea sottoattività').'", "'.$module->fileurl('modals/crea_sottoattivita.php').'?id_module='.$id_module.'&id_record='.$id_record.'");
    }
